...
def main():
    guardar_evidencias(range(84, 108), "android")
    guardar_evidencias(range(227, 251), "ios")
...
def guardar_evidencias(rango, subcarpeta):
    ...
    output_folder ="C:\\OneDrive - Money Free Flex\\Documents\\entregable6"
    ...
    ruta = "C:\\OneDrive - Money Free Flex\\Documents\\entregable6_v2.xlsx"
    fila_min = 12
    sheetName = "MP"
